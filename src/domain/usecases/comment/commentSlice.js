...
export const addComment = createAsyncThunk(
  ...
  async ({ eventId, content }, { rejectWithValue }) => {
    try {
      const response = await axios.post(`https://mobile-backend-jz8h.vercel.app/events/${eventId}/comments`, { content });
...
export const deleteComment = createAsyncThunk(
	...
	try {
	  const response = await axios.delete(`https://mobile-backend-jz8h.vercel.app/events/${eventId}/comments/${commentId}`);
...
export const getEventComments = createAsyncThunk(
  ...
  async (eventId, { rejectWithValue }) => {
    try {
      const response = await axios.get(`https://mobile-backend-jz8h.vercel.app/events/${eventId}/comments`);
